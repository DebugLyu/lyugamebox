"use strict";
cc._RFpush(module, '5f583s9OrdKKrfgFIKdz+XC', 'Msgcode');
...
// 账号状态
msgcode.ACCOUNT_TOO_LONG = "账号或密码长度错误，请输入6~12位字符", msgcode.PASSWORD_NOT_SAME = "两次输入的密码不相同", msgcode.NETWORK_RELINK = "网络已断开，正在重连", msgcode.NETWORK_RELOGIN = "网络已断开，请重新登录", msgcode.NETWORK_UNCONNECT = "无法连接到服务器", msgcode.NETWORK_OTHER_LOGIN = "账号在其他地方登陆", msgcode.GOLD_NOT_ENOUGH = "金币不足",
//推饼 状态
